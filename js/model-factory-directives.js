var modelApp = angular.module("ModelFactory");

modelApp.directive('workspaceTabs', ['$rootScope', '$state', function($rootScope, $state) {
  
  return {
    restrict: "E",
    templateUrl: "templates/workspace-tabs.html",
    scope: {
      tabs: '=data',
      type: '@',
      justified: '@',
...
modelApp.directive('breadcrumb', ['$interpolate', '$state', function($interpolate, $state) {
  return {
    restrict: "E",
